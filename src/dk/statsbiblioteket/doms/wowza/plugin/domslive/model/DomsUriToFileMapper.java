...
public class DomsUriToFileMapper implements IMediaStreamFileMapper {
     ...
     * @param storageDir
     */
    public DomsUriToFileMapper(String storageDir, String format, String ticketInvalidErrorFile, String ticketCheckerLocation) {
        getLogger().info("Entered DomsUriToFileMapper(...)");
        this.sdf = new SimpleDateFormat(format);
        this.rickrollFilename = ticketInvalidErrorFile;
        this.ticketCheckerLocation = ticketCheckerLocation;
