...
public class TicketTool implements TicketToolInterface {
    ...
    public Ticket issueTicket(String username, String resource, List<TicketProperty> properties) {
        try {
            WebResource query = restApi.path("/issueTicket").queryParam("username", username)
    ...
    public static void main(String args[]) {
        ...
        System.out.println("");
        System.out.println(
                "Input parameters for Wowza's test client <Wowza-install-dir>/examples/SimpleVideoStreaming/client/simplevideostreaming.html");
        System.out.println("");
        System.out.println(
                "-[kultur]------------------------------------------------------------------------------------------------------------------");
