...
public class StreamingStatExtractor {
    ...
    public StreamingStatExtractor(WMSLogger logger, String logFilesBaseDir, String startDateString,
                                  String endDateString) throws IOException, ParseException {
        super();
        this.logger = logger;
    ...
    public static void main(String args[]) throws IOException, ParseException {
        if (args.length < 3) {
            ...
            System.out.println("");
            System.out.println(
                    "Parameter example: /home/wowza/services/wowza_vhost_kultur/logs/streamingStatistics 2011-04-08 2011-04-15");
            System.exit(1);
        }
        ...
        Appender fileAppender = new FileAppender(layout, StreamingStatExtractor.class.getSimpleName() + "-" + sdf
                .format(new Date()) + ".log", true);
        ...
        StreamingStatExtractor extractor = new StreamingStatExtractor(logger, logFileBaseDir, startDateString,
                                                                      endDateString);
        System.out.println("=========================================================================================");
        System.out.println(
                "Analyzing streaming statistics log for the period: " + startDateString + " - " + endDateString);
