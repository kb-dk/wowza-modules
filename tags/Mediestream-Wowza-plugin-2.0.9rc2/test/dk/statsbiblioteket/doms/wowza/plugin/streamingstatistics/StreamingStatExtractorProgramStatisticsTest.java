...
public class StreamingStatExtractorProgramStatisticsTest  extends TestCase {
	...
	@Test
 	public void testAddMultipleEntries() throws InvalidLogLineParseException, HeadlineEncounteredException {
		...
		assertEquals("Program-1, Kanal-1 2011-03-01 count", 4, programStat.getPlayCount("Program-1", "Kanal-1", "2011-03-01T20:00:00+0100"));
		assertEquals("Program-1, Kanal-2 2011-03-01 count", 3, programStat.getPlayCount("Program-1", "Kanal-2", "2011-03-01T20:00:00+0100"));
		assertEquals("Program-1, Kanal-3 2011-03-04 count", 6, programStat.getPlayCount("Program-1", "Kanal-3", "2011-03-04T20:00:00+0100"));
		assertEquals("Program-2, Kanal-1 2011-02-04 count", 1, programStat.getPlayCount("Program-2", "Kanal-1", "2011-02-04T20:00:00+0100"));
		// Ikke eksisterende
		...
		assertEquals("Program-1, Kanal-1 2011-03-07 count", 0, programStat.getPlayCount("Program-1", "Kanal-1", "2011-03-07T20:00:00+0100"));
		assertEquals("Program-1, Kanal-4 2011-03-07 count", 0, programStat.getPlayCount("Program-1", "Kanal-4", "2011-03-07T20:00:00+0100"));
		assertEquals("Program-3, Kanal-1 2011-03-07 count", 0, programStat.getPlayCount("Program-3", "Kanal-1", "2011-03-07T20:00:00+0100"));
	}
